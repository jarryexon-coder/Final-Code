...
// Import models
const SecretPhraseAnalytics = require('../models/SecretPhraseAnalytics'); // Add this line
...
router.post('/secret-phrase/record', authenticateToken, async (req, res) => {
  try {
    const {
      phraseKey,
      phraseCategory,
...
router.get('/secret-phrase/user', authenticateToken, async (req, res) => {
  try {
    const { 
      startDate, 
      endDate, 
...
router.get('/secret-phrase/realtime', authenticateToken, async (req, res) => {
  try {
...
router.get('/secret-phrase/performance/:category', authenticateToken, async (req, res) => {
  try {
...
router.get('/secret-phrase/leaderboard', authenticateToken, async (req, res) => {
  try {
