...
// Default export
export default {
  getPrizePicksPreferences,  getUserPreferences,
  updatePreferences,
  resetPreferences,
...
// getPrizePicksPreferences - Added for userPreferencesRoutes.js
export const getPrizePicksPreferences = async (req, res) => {
  try {
    res.json({
      success: true,
      message: "getPrizePicksPreferences",
      data: req.body || {}
    });
  } catch (error) {
